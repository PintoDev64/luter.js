 ...
 */
export function Toggle({ image, className, borderRadius = 'round', onClick, ...props }: ToggleProps) {
    ...
    const img_Source = (image === undefined || image.length === 0) ? Repeat.ImagePlaceholder : image
